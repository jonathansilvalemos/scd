                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="scd-container-valores">
                                            <div className="scd-form-container-cadastro">
                                                ...
                                                <input className="scd-form-control valores" type="text" value="R$ 77,00" disabled />
                                            </div>
                                            <div className="scd-form-container-cadastro">
                                                <label className="mt-3" htmlFor="valor">Valor Gasto:</label><br />
                                                <input className="scd-form-control valores" type="text" placeholder="Despesa do dia R$" />
                                            </div>
                                            <div className="scd-form-container-cadastro">
